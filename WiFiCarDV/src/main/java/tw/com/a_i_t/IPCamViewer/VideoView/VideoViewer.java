...
public class VideoViewer extends SurfaceView implements IVLCVout.Callback {
    ...
    private void init() {
        ...
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(MainWiFiActivity.getAppContext()) ;
...
//                toast.show();
            ...
            //releasePlayer();
            Toast.makeText(MainWiFiActivity.getAppContext(), "Error creating player!", Toast.LENGTH_LONG).show();
        }
    }
