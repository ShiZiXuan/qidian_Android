    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewTag = new ViewTag((ImageView) convertView.findViewById(R.id.fileListThumbnail),
                    ...
                    (TextView) convertView.findViewById(R.id.name_tv));
        ...
        String filename = viewTag.mFileNode.mName.replace("\\", "/");
        filename = filename.substring(filename.lastIndexOf("/") + 1);
        filename = filename.substring(4);
        filename = "20" + filename.substring(0, filename.length() - 1 - 4).replace("-", "_");// + "A.MOV";
        filename = filename.replace("_", "");
        filename = filename.substring(0, 4) + "." + filename.substring(4, 6) + "."
                + filename.substring(6, 8) + " "
                + filename.substring(8, 10) + ":"
                + filename.substring(10, 12) + ":" + filename.substring(12, 14);


        viewTag.name_tv.setText(filename);
