...
/**
 * customized ImageView，Rounded Rectangle and border is implemented, and change color when you
 * press
 */
public class EaseImageView extends ImageView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      borderWidth =
          array.getDimensionPixelOffset(R.styleable.EaseImageView_ease_border_width, borderWidth);
