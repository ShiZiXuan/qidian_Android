...
public class GlViewDec extends GLSurfaceView
{
    ...
    public GlViewDec(Context context, AttributeSet att)
	{
        super(context, att);
    ...
    public GlViewDec(Context context, boolean translucent, int depth, int stencil)
	{
        super(context);
	...
	private static void checkEglError(String prompt, EGL10 egl)
	{
		...
		{
//			Util.Log(TAG, String.format("%s: EGL error: 0x%x", prompt, error));
		}
	}
