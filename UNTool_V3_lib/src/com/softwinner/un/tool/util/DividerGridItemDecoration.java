...
/**
 * Created by linjing on 2017/6/30.
 * 设置gridview的分割线
 */
...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration() {
        mDivider = new ColorDrawable(Color.parseColor("#e3e3e3"));
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (isLastColum(parent, itemPosition, spanCount, childCount) && isLastRaw(parent, itemPosition, spanCount, childCount)) {
            outRect.set(0, 0, 0, 0);
